import { excluirAluno, excluirInstrutor } from '../codigo/PROJETO-ACADEMIA-master/TS/acesso-adm';
...
describe('Testes das funções de cadastro e exclusão', () => {
    ...
    test('deve excluir um aluno corretamente', () => {
        ...
        excluirAluno.mockImplementation((index) => {
    ...
    test('deve excluir um instrutor corretamente', () => {
        ...
        excluirInstrutor.mockImplementation((index) => {
