...
var acesso_adm_1 = require("./acesso-adm");
...
jest.mock('./acesso-adm', function () { return ({
...
describe('Testes das funções de cadastro e exclusão', function () {
    beforeEach(function () {
        // Limpar o mock do localStorage antes de cada teste
        localStorage.clear();
    });
    test('deve excluir um aluno corretamente', function () {
        var alunosMock = [
        ...
        localStorage.getItem.mockReturnValueOnce(JSON.stringify(alunosMock));
        // Definir a implementação da função excluirAluno como uma função mockada
        acesso_adm_1.excluirAluno.mockImplementation(function (index) {
        ...
        (0, acesso_adm_1.excluirAluno)(0); // Excluir aluno no índice 0
    ...
    test('deve excluir um instrutor corretamente', function () {
        var instrutoresMock = [
        ...
        // Mock do comportamento do localStorage
        localStorage.getItem.mockReturnValueOnce(JSON.stringify(instrutoresMock));
        // Definir a implementação da função excluirInstrutor como uma função mockada
        acesso_adm_1.excluirInstrutor.mockImplementation(function (index) {
        ...
        (0, acesso_adm_1.excluirInstrutor)(1); // Excluir instrutor no índice 1
